...
int __l4_snprintf (char *str, size_t size, const char *fmt, ...);
int snprintf (char *str, size_t size, const char *fmt, ...)
    __attribute__ ((weak, alias ("__l4_snprintf")));
int __l4_vsnprintf (char *str, size_t size, const char *fmt, va_list);
 ...
 *
 */
int __l4_vsnprintf(char *str, size_t size, const char *fmt, va_list ap)
{
    char convert[64];
